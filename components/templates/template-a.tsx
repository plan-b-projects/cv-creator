    ...
    return (
        <>
            <div className="basicInfo">
                ...
                <div className="linkedIn"><a href={data?.basicInfo.location}>LinkedIn</a></div>
                <div className="github"><a href={data?.basicInfo.gitHub}>GitHub</a></div>
                <div className="github"><a href={data?.basicInfo.website}>Website</a></div>
            </div>
